...
public sealed record SourceFileInfo(string RelativePath, string FileName, long Size, DateTime ModifiedAt,string? ObjectPath = null)
{
...
public interface ICollectSource
{
    ...
    /// 擦除记录仪文件
    /// </summary>
    Task<int> EraseAsync(CollectDeviceInfo device, IEnumerable<SourceFileInfo> files, CancellationToken cancellationToken);
