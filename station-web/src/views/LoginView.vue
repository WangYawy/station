...
<style scoped>
.login-wrap { height: 100vh; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #0a2f6c 0%, #12408a 100%); }
.login-card { width: 360px; }
.title { text-align: center; color: #0a2f6c; margin: 4px 0 18px; }
.submit { width: 100%; }
</style>
